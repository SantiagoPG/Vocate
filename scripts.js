const translations = {
  es: {
    ...
    cancelar: "Cancelar",
    confirmarPedidoTitulo: "¿Confirmas tu pedido?",
    productos: {
      cerveza: {
        nombre: "Cerveza Vocate",
        descripcion: "Esta bendita y refrescante cerveza artesanal destaca por su equilibrio perfecto entre cuerpo y sabor, con vibrantes notas cítricas que despiertan los sentidos. Con un 5% de alcohol, es ideal para quienes buscan disfrutar de una bebida ligera, pero con carácter."
      },
      mango: {
        nombre: "Mango Biche",
        descripcion: "Tiritas de mango verde fresco servidas en copa, acompañadas de una rodaja de limón para resaltar su sabor ácido y refrescante. 🌱 Perfecto para abrir el apetito o disfrutar con una cerveza artesanal bien fría."
      },
      nachos: {
        nombre: "Nachos",
      ...
      aguacate: {
        ...
        descripcion: "Mitad de aguacate fresco relleno con una mezcla vibrante de camarones cocidos, tomate, cebolla morada, pimentón y cilantro, todo bañado en un toque de jugo de limón. 🌊 Una explosión tropical de frescura, suavidad y textura."
      }
    }
  },
  en: {
...
function updateTexts() {
  ...
  // Actualizar el botón de confirmar pedido con el total
...
function getProductKey(spanishName) {
  const productMap = {
    ...
    'Nachos': 'nachos',
    'Mani Salado': 'mani',
    'Aguacate relleno con ceviche de camarón': 'aguacate'
  };
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Botón para confirmar pedido abre el modal
  const confirmButton = document.getElementById('confirm-order-btn');
  if (confirmButton) {
    confirmButton.addEventListener('click', openModal);
  }

  // Botón dentro del modal que realmente envía el pedido
